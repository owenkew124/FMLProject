...
for student in np.arange(1,2): 
    ...
    while c < num_files and not f:
        score_points = np.load(str(dataset_name) + "/st" + str(student) + "/scores/" + str(c) + "score.npy", allow_pickle=True)
        if score_points.size == 0:
            ...
            c += 1
            continue
        green_points = np.load(str(dataset_name) + "/st" + str(student) + "/points/" + str(c) + "_green.npy", allow_pickle=True)
        ...
        red_points = np.load(str(dataset_name) + "/st" + str(student) + "/points/" + str(c) + "_red.npy", allow_pickle=True)
